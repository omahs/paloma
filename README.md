...
The current required version of libwasm is `1.2.3`. If you're upgrading from a prior version it is recommended to remove the cache to avoid errors. If you already have `palomad` running, you will need to stop it before doing these steps.
